...
let key = String.UTF8.encode(vectors[0][0]);
let value = String.UTF8.encode(vectors[0][1]);
let expected = (<u64>parseInt(vectors[0][2].slice(0, 8), 16) << 32) | <u64>parseInt(vectors[0][2].slice(8), 16);
